...
list_, type_attribute = G.NonTerminals("<list> <type_attribute>")
...
variable %= identifier + colon + identifier, lambda h, s: ParameterNode(s[1].NAME, s[3])
#
...
protocol_declare %= protocol + identifier + extends + identifier + lbrack + protocol_body + rbrack, lambda h, s: ProtocolNode(s[2].NAME, s[6], s[4].NAME)
#
protocol_body %= identifier + typed_parameters + colon + identifier + semicolon, lambda h, s: ProtocolMethodNode(s[1].NAME, s[2], s[4].NAME)
protocol_body %= identifier + typed_parameters + colon + identifier + semicolon + protocol_body, lambda h, s: [ProtocolMethodNode(s[1].NAME, s[2], s[3].NAME)] + s[6]
#
typed_parameters %= lparen + rparen, lambda h, s: []
typed_parameters %= lparen + typed_parameter_list + rparen, lambda h, s: s[2]
#
typed_parameter_list %= identifier + colon + identifier, lambda h, s: [ParameterNode(s[1].NAME, s[2].NAME)]
...
#
simple_expression %= let + declaration + in_ + expression, lambda h, s: LetNode(s[2][0], s[2][0], s[3])
...
arithmetic_expression %= arithmetic_expression + plus + module, lambda h, s: ArithmeticExpression(s[2].NAME, s[1], s[3])
arithmetic_expression %= arithmetic_expression + minus + module, lambda h, s: ArithmeticExpression(s[2].NAME, s[1], s[3])

module %= product, lambda h, s: s[1]
module %= module + modulus + product, lambda h, s: ArithmeticExpression(s[2].NAME, s[1], s[3])
#
product %= monomial, lambda h, s: s[1]
product %= product + times + monomial, lambda h, s: ArithmeticExpression(s[2].NAME, s[1], s[3])
product %= product + divide + monomial, lambda h, s: ArithmeticExpression(s[2].NAME, s[1], s[3])
product %= product + int_divide + monomial, lambda h, s: ArithmeticExpression(s[2].NAME, s[1], s[3])
#
monomial %= pow_, lambda h, s: s[1]
monomial %= minus + monomial, lambda h, s: ArithmeticExpression(s[1].NAME, NumberNode(0), s[2])
#
pow_ %= high_hierarchy_object, lambda h, s: s[1]
pow_ %= pow_ + power_asterisk + high_hierarchy_object, lambda h, s: ArithmeticExpression(s[2].NAME, s[1], s[3])
pow_ %= pow_ + power + high_hierarchy_object, lambda h, s: ArithmeticExpression(s[2].NAME, s[1], s[3])
#
...
type_attribute %= type_attribute + period + identifier, lambda h, s: SelfVariableNode(True, s[3])
...
object_exp %= identifier + arguments, lambda h, s: FunctionCallNode(s[1].NAME, s[2])
...
object_exp %= rand + lparen + rparen, lambda h, s: FunctionCallNode(s[1].NAME, [])
#
