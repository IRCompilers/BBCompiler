...
testcase29 = ('protocol Equatable extends Hashable { equals(other:Object): Boolean; }'
              '4;')
...
testcase46 = 'let a = b.a() as int in print(a);'
...
testcase50 = ('type A { a = 0; b = 0; c = 0; d: int = 1; getX() => self.a; }'
